    ...
    function installCode(code_0){
      ...
      if (MySampleApplication.__errFn) {
        script.onerror = function(){
          MySampleApplication.__errFn($intern_4, new Error($intern_22 + code_0));
        }
        ;
      }
